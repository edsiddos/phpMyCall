...
CREATE TABLE phpmycall.projeto_tipo_problema(
	...
	FOREIGN KEY fk_projeto_projeto_tipo_problema(projeto) REFERENCES phpmycall.projeto(id),
	FOREIGN KEY fk_problema_projeto_tipo_problema(problema) REFERENCES phpmycall.tipo_problema(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE phpmycall.opcoes_menu(
	...
	FOREIGN KEY fk_menu_pai_opcoes_menu(menu_pai) REFERENCES phpmycall.opcoes_menu(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE phpmycall.permissao_perfil(
	...
	FOREIGN KEY fk_menu_permissao_perfil(menu) REFERENCES phpmycall.opcoes_menu (id),
	FOREIGN KEY fk_perfil_permissao_perfil(perfil) REFERENCES phpmycall.perfil (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE phpmycall.usuario(
	...
	FOREIGN KEY fk_perfil_usuario(perfil) REFERENCES phpmycall.perfil (id),
	FOREIGN KEY fk_empresa_usuario(empresa) REFERENCES phpmycall.empresas (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE phpmycall.solicitacao(
	...
	FOREIGN KEY fk_projeto_problema_solicitacao(projeto_problema) REFERENCES phpmycall.projeto_tipo_problema (id),
        FOREIGN KEY fk_prioridade_solicitacao(prioridade) REFERENCES phpmycall.prioridade (id),
	FOREIGN KEY fk_solicitante_solicitacao(solicitante) REFERENCES phpmycall.usuario(id),
	FOREIGN KEY fk_atendente_solicitacao(atendente) REFERENCES phpmycall.usuario(id),
	FOREIGN KEY fk_tecnico_solicitacao(tecnico) REFERENCES phpmycall.usuario(id),
	FOREIGN KEY fk_solicitacao_origem_solicitacao(solicitacao_origem) REFERENCES phpmycall.solicitacao (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE phpmycall.arquivos(
	...
	FOREIGN KEY fk_solicitacao_arquivos(solicitacao) REFERENCES phpmycall.solicitacao (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE phpmycall.feedback(
	...
	FOREIGN KEY fk_tipo_feedback_feedback(tipo_feedback) REFERENCES phpmycall.tipo_feedback (id),
	FOREIGN KEY fk_solicitacao_feedback(solicitacao) REFERENCES phpmycall.solicitacao (id),
	FOREIGN KEY fk_responsavel_feedback(responsavel) REFERENCES phpmycall.usuario (id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE phpmycall.projeto_responsaveis(
	...
	FOREIGN KEY fk_usuario_projeto_responsaveis(usuario) REFERENCES phpmycall.usuario(id),
	FOREIGN KEY fk_projeto_projeto_responsaveis(projeto) REFERENCES phpmycall.projeto(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
...
CREATE TABLE phpmycall.log(
	...
	FOREIGN KEY fk_usuario_log(usuario) REFERENCES phpmycall.usuario(id)
) ENGINE=InnoDB DEFAULT CHARSET=utf8;
